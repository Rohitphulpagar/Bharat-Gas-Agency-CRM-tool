...
public static void printReport(Delivery[] obj) {
 ...
 for(int i=0; i<obj.length;i++)
 {
	...
	public static void main(String[] args) {
		...
		deliveryObject[0]=new Delivery ("Rohit","4th Avenue","Alpha-2","431705","201325",1);
		deliveryObject[1]=new Delivery ("Nagesh","4th Avenue","Alpha-2","431706","205525",2);
		deliveryObject[2]=new Delivery ("Reshama","4th Avenue","Alpha-2","431755","206625",1);
		deliveryObject[3]=new Delivery ("Virat","4th Avenue","Alpha-2","431001","201377",2);
		deliveryObject[4]=new Delivery ("Anushka","PI-4","Alpha-2","431705","201325",1);
